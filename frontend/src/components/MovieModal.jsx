...
export default function MovieModal({ selectedMovie, setSelectedMovie }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4 mb-10">
      <div className="bg-gray-800 p-6  rounded-lg max-w-4xl w-full text-white relative flex gap-6 ">
        <div className="overflow-y-auto flex flex-col md:flex-row max-h-[90vh]">
          {/* Close Button */}
          <button
          ...
          <div className="flex-1 mb-4 p-4 md:max-h-[80vh]">
            {showPlaceholder ? (
          ...
          <div className="flex-1 md:overflow-y-auto">
            <div className="bg-gray-700 p-4 rounded-lg ">
              ...
              <div className="flex flex-col gap-3 overflow-y-scroll h-50 m:h-90 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                {
            ...
            <div className="mt-4 bg-gray-700 p-4 rounded-lg mb-6">
